...
func TestGatewayPolicyResourceRoutes(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{http.MethodPost, "/api/threads/x/suggestions", ThreadsRead},
		{http.MethodPost, "/api/assistants/search", ResourcesRead},
		...
		{http.MethodGet, "/api/channels", ChannelsRead},
		{http.MethodGet, "/api/channels/providers", ChannelsRead},
		{http.MethodGet, "/api/channels/connections", ChannelsRead},
		{http.MethodPost, "/api/channels/slack/connect", ChannelsWrite},
		{http.MethodDelete, "/api/channels/connections/chn_id", ChannelsWrite},
		{http.MethodGet, "/api/channel-connections", ChannelsRead},
		{http.MethodPost, "/api/channel-connections", ChannelsWrite},
		{http.MethodDelete, "/api/channel-connections/chn_id", ChannelsWrite},
		{http.MethodGet, "/api/channels-extra", Admin},
