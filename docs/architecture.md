...
| `internal/channel` | Durable channel identities, conversation mapping, dedupe, bounded dispatch, signed webhooks, and native Slack, Telegram, and Discord adapters |
