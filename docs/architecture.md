...
| `internal/channel` | Durable channel identities, conversation mapping, dedupe, bounded dispatch, signed webhooks, and native Slack, Telegram, Discord, Feishu/Lark, and DingTalk adapters |
